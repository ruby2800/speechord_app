...
//             <Tab.Screen name="逐字稿" component={this.Transcript} 
//                       options={{
...
//                       }}
//             />
//             <Tab.Screen name="摘要稿" component={this.Summary} 
//                       options={{
//                         tabBarIcon: ({ color, size }) => (
...
//           leftComponent={{ icon: 'menu', type:'entypo', color: '#fff', underlayColor: '#3488C0', 
